    ...
    <head>
        ...
        <style>
            ...
            * { font-family: {{ app()->getLocale() === 'ar' ? "'Cairo'" : "'Inter'" }}, sans-serif; box-sizing: border-box; }
            ...
            .sidebar { position: fixed; top: 0; {{ app()->getLocale() === 'ar' ? 'right: 0;' : 'left: 0;' }} width: var(--sidebar-w); height: 100vh; background: linear-gradient(135deg, #1e1b2e 0%, #2d1f3d 50%, #1a1625 100%); z-index: 50; display: flex; flex-direction: column; transition: transform 0.3s cubic-bezier(0.4,0,0.2,1); overflow-y: auto; overflow-x: hidden; }
