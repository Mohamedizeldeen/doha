            ...
            <section class="px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-[#fde4f1] to-white py-12 sm:py-20">
                <div class="max-w-6xl mx-auto text-center">
                    <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-4 sm:mb-6">
                        <span class="bg-gradient-to-r from-[#dd208e] to-[#b01670] bg-clip-text text-transparent">{{ __('admin.blog') }}</span>
                    </h1>
                    <p class="text-lg sm:text-xl text-gray-600">
                        {{ __('admin.blog_subtitle') }}
                    </p>
                </div>
            </section>
            ...
            <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
                ...
                @else
                    <div class="bg-white rounded-lg shadow-md p-12 text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-2">{{ __('admin.no_articles_yet') }}</h3>
                        <p class="text-gray-600 mb-6">{{ __('admin.adding_content_soon') }}</p>
