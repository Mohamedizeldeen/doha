...
@section('page-title', __('admin.edit_client'))

@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-800">{{ __('admin.edit') }}: {{ $client->name_ar }}</h2>
</div>
...
<div class="bg-white rounded-lg shadow-md p-8 max-w-2xl">
    <form method="POST" action="{{ route('client.update', [$salon, $client]) }}" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Client Code -->
            <div>
                <label for="client_code" class="block text-sm font-medium text-gray-700 mb-2">{{ __('admin.client_code') }}</label>
