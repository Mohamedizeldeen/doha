...
@section('page-title', __('admin.edit_staff'))

@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-800">{{ __('admin.edit_staff') }}: {{ $staff->name_ar }}</h2>
</div>
...
<div class="bg-white rounded-lg shadow-md p-8 max-w-2xl">
    <form method="POST" action="{{ route('staff.update', [$salon, $staff]) }}" class="space-y-6">
        ...
        <!-- Services -->
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('admin.services') }}</label>
